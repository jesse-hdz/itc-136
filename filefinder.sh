...
then
    ...
    echo -en "\e[45m     '${fname}' is : $filewhereis "
         if which -a "$fname"  #$filewhich
         then
             echo -en "\e[42m     File '${fname}' is executable."
         else
             echo -en "\e[41m     File '${fname}' is not executable or found."
         fi
else
    echo -en "\e[41m     File '${fname}' not found. "
fi
